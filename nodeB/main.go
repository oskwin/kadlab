...
func main() {
	...
	me := d7024e.NewContact(d7024e.NewKademliaID("5122111200000000000000000000000000000000"), "localhost:8001")
	...
	rt.AddContact(d7024e.NewContact(d7024e.NewKademliaID("8111112300000000000000000000000000000000"), "localhost:8002"))
	rt.AddContact(d7024e.NewContact(d7024e.NewKademliaID("9122111400000000000000000000000000000000"), "localhost:8003"))
	rt.AddContact(d7024e.NewContact(d7024e.NewRandomKademliaID(), "localhost:8004"))
	for i := 0; i <= 50; i++ {
